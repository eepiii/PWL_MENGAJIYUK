                    ...
                    <div class="panel-body" style="padding: 25px;">
                        ...
                        <div style="margin-bottom: 20px; border-top: 1px solid #eee; padding-top: 15px;">
                            <h4 style="font-weight: bold; color: #333; margin-bottom: 3px;">
                                {{ $item->namaLatin ?? $item->nama_latin }}
                            </h4>
                            ...
                            <span class="label label-success" style="background-color: #157347; font-weight: normal; font-size: 11px;">
                                {{ $item->jumlahAyat ?? $item->jumlah_ayat }} Ayat
                            </span>
                        </div>

                        <div style="margin-top: 15px;">
                            <a href="/quran/{{ $item->nomor ?? $item->nomor_surah }}" class="btn btn-block btn-primary" style="background-color: #0f5132; border-color: #0f5132; font-weight: bold; border-radius: 6px; padding: 10px 15px; font-size: 14px;">
